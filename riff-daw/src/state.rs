...
impl DAWState {
    ...
    pub fn get_riff_set_play_events(&self, riff_set: &RiffSet, track_riff_refs_map: &mut HashMap<String, Vec<RiffReference>>, track_running_position: &mut HashMap<String, f64>) {
        let mut riff_lengths = vec![];
